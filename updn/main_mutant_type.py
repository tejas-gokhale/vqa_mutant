...
from dataset_mutant_type import Dictionary, VQAFeatureDataset
import base_model_type
from train_type import train
import utils
...
def main():
    ...
    dictionary = Dictionary.load_from_file('data/mutant_both_vqacp_v2/dictionary.pkl')
    cp = not args.nocp

    print("Building train dataset...")
    train_dset = VQAFeatureDataset('train', dictionary, 
                    dataroot='data/mutant_both_vqacp_v2/', 
                    cp=cp, cache_image_features=args.cache_features)
    print("Building test dataset...")
    eval_dset = VQAFeatureDataset('val', dictionary,  dataroot='data/mutant_both_vqacp_v2/', 
                    cp=cp, cache_image_features=args.cache_features)
    ...
    model = getattr(base_model_type, constructor)(train_dset, args.num_hid).cuda()
    model.w_emb.init_embedding('data/mutant_both_vqacp_v2/glove6b_init_300d.npy')
