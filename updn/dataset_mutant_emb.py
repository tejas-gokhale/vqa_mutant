...
class VQAFeatureDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if "bias" in entry:
            return features, question, target, entry["bias"], torch.Tensor(answertypefeats), top_ans_emb
        else:
            return features, question, target, 0, torch.Tensor(answertypefeats), top_ans_emb
