...
from dataset_mutant_emb_type import Dictionary, VQAFeatureDataset
import base_model_emb_type
from train_emb_type import train
import utils
...
def main():
    ...
    model = getattr(base_model_emb_type, constructor)(train_dset, args.num_hid).cuda()
