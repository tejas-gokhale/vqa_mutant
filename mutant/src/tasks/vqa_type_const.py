    ...
    def train(self, train_tuple, eval_tuple):
        ...
        for epoch in range(args.epochs):
            ...
            for i, (ques_id, feats, boxes, ques, op, q1, q2, typetarget, q1typetarget, q2typetarget, yesnotypetargets, q1yntypetargets, q2yntypetargets, target, q1_target, q2_target) in iter_wrapper(enumerate(loader)):
                ...
                # The actual question
                logit,type_logit = self.model_forward(feats, boxes, ques,target,yntypetarget )
...
#                 loss_yn = loss_yn*yn_type_logit.size(1)
                ...
                q1_logit,q1_type_logit  = self.model_forward(feats,boxes,q1,q1_target,q1yntypetargets)

                q2_logit,q2_type_logit  = self.model_forward(feats,boxes,q2,q2_target,q2yntypetargets)
