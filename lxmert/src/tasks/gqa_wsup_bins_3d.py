...
from tasks.gqa_model_wsup_bins_3d import GQAModel
from tasks.gqa_data_wsup_bins_3d import GQADataset, GQATorchDataset, GQAEvaluator
...
#                 loss.backward()
    ...
    def oracle_score(data_tuple):
        ...
        quesid2ans = {}
        for i, (ques_id, feats, boxes, sent, img_feats, target, sp_target) in tqdm(enumerate(loader),total=len(loader)):
