...
#             print(ques_id, feats, boxes, ques, target, torch.tensor(spatial_labels))
            return int(ques_id), torch.tensor(feats).float(), torch.tensor(boxes).float(), ques, img_raw_data, target, torch.tensor(spatial_labels)
        else:
#             print( ques_id, feats, boxes, ques)
            return int(ques_id), torch.tensor(feats).float(), torch.tensor(boxes).float(), ques, img_raw_data
