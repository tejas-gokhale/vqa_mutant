...
from tasks.gqa_model_wsup_bins_3d_patches_embs import GQAModel
from tasks.gqa_data_wsup_bins_3d_patches_embs import GQADataset, GQATorchDataset, GQAEvaluator
