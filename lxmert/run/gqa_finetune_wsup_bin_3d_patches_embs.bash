...
CUDA_VISIBLE_DEVICES=$1 PYTHONPATH=$PYTHONPATH:./src \
    python src/tasks/gqa_wsup_bins_3d_patches_embs.py \
...
# CUDA_VISIBLE_DEVICES=$1 PYTHONPATH=$PYTHONPATH:./src \
#     python -m torch.distributed.launch --nproc_per_node=${#strarr[*]} --master_port=$MASTER_PORT src/tasks/gqa_wsup_bins_3d_patches_embs.py \
#     --train others --valid testdev_others \
#     --llayers 9 --xlayers 5 --rlayers 5 \
#     --loadLXMERT  /data/data/lxmert_data/snap/pretrained/model \
